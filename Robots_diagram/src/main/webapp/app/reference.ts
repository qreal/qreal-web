...
/// <reference path="twoDModel/implementations/robotModel/TrikKit/TrikRobotModelBaseImpl.ts" />
...
/// <reference path="twoDModel/interfaces/robotModel/TrikKit/TrikRobotModelBase.ts" />
