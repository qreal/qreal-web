...
joint.shapes.devs.ImageWithPorts = joint.shapes.basic.Generic.extend(_.extend({}, joint.shapes.basic.PortsModelInterface, {
    markup: '<g class="rotatable"><g class="scalable"><rect class ="outer"/><image/></g><text/><g class="inPorts"/><g class="outPorts"/></g>',
    portMarkup: '<g class="port<%= id %>"><circle/><text/></g>',

    defaults: joint.util.deepSupplement({

        type: 'devs.ImageWithPorts',
        size: { width: 1, height: 1 },
...
joint.shapes.devs.RectWithPorts = joint.shapes.devs.Model.extend({
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            '.inPorts circle': { fill: 'PaleGreen' },
            '.outPorts circle': { fill: 'blue', type: "output" },
            '.label': { text: 'Text', 'ref-y': 0.45  },
            '.outer': {
