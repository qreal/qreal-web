(function()
{
 ...
 Runtime.Define(Global,{
  ...
  Website:{
   AddDiagramControl:Runtime.Class({
    get_Body:function()
    {
     return Forms.AddDiagram();
    }
   }),
   Canvas:{
   ...
   Forms:{
    AddDiagram:function()
    {
     var textForm,x,x1,f,f1,fc,inputRecord,Description,x2,f2,f3,x3,_builder_,f4;
     textForm=(x=(x1=Forms.DiagramTitleForm(),(f=function(formlet)
     {
     ...
     },f2("Please enter diagram title.")),(f3=function(arg0)
     {
      return{
       $:1,
       $0:arg0
     ...
     x3=(_builder_=Formlet1.Do(),_builder_.Delay(function()
     {
      return _builder_.Bind(textForm,function(_arg1)
      {
       var value,_1;
       return _builder_.ReturnFrom((value=Remoting.Call("Website:5",[Remoting.Call("Website:0",[]),_arg1]),value,(_1=window,(_1.location="/","/"),Formlet1.Return(null))));
      });
     }));
     f4=function(formlet)
     {
    ...
    LoginForm:function(redirectUrl)
    {
     ...
     x7=(_builder_=Formlet1.Do(),_builder_.Delay(function()
     {
      ...
      {
       var a,f7;
       return _builder_.ReturnFrom((a=Remoting.Async("Website:1",[_arg1]),(f7=function(loggedIn)
       {
        var _1;
        if(loggedIn)
         {
    ...
    RegisterForm:function()
    {
     ...
     x7=(_builder_=Formlet1.Do(),_builder_.Delay(function()
     {
      ...
      })),f6(registerF)),Runtime.Tupled(function(_arg1)
      {
       ...
       return _builder_.ReturnFrom((a=(user=_arg1[0],(pass=_arg1[1],(confirm=_arg1[2],Remoting.Async("Website:2",[user,pass,confirm])))),(f7=function(_arg2)
       {
        var _1;
        if(_arg2.$==2)
         {
